...
export const Compass = () => {
	...
	useEffect(() => {
		...
		const handleOrientation = (event: DeviceOrientationEvent) => {
			...
			if (event.alpha >= 337.5 || event.alpha < 22.5) setDirection("North")
			else if (event.alpha >= 22.5 && event.alpha < 67.5) setDirection("North-East")
			else if (event.alpha >= 67.5 && event.alpha < 112.5) setDirection("East")
			else if (event.alpha >= 112.5 && event.alpha < 157.5) setDirection("South-East")
			else if (event.alpha >= 157.5 && event.alpha < 202.5) setDirection("South")
			else if (event.alpha >= 202.5 && event.alpha < 247.5) setDirection("South-West")
			else if (event.alpha >= 247.5 && event.alpha < 292.5) setDirection("West")
			else if (event.alpha >= 292.5 && event.alpha < 337.5) setDirection("North-West")
		}
